                ...
                <form action="../controller/midia-create.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="genero" required>
                            <option value="Romance" <?php if(($midia->genero ?? '')=='Romance') echo 'selected'; ?>>
                                Romance
                            </option>
                            <option value="Ação" <?php if(($midia->genero ?? '')=='Ação') echo 'selected'; ?>>Ação
                            </option>
                            <option value="Comédia" <?php if(($midia->genero ?? '')=='Comédia') echo 'selected'; ?>>
                                Comédia
                            </option>
                            ...
                            <option value="Aventura" <?php if(($midia->genero ?? '')=='Aventura') echo 'selected'; ?>>
                                Aventura</option>
                            <option value="Musical" <?php if(($midia->genero ?? '')=='Musical') echo 'selected'; ?>>
                                Musical
                            </option>
                            <option value="Suspense" <?php if(($midia->genero ?? '')=='Suspense') echo 'selected'; ?>>
                                Suspense</option>
                            <option value="Documentario"
                                <?php if(($midia->genero ?? '')=='Documentario') echo 'selected'; ?>>Documentário
                            </option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="episodio" id="episodio" value="<?php echo $midia->episodio ?? ''; ?>">
                    </div>
